...
In order to extract **rais** data,  you use the *rais function*. To use this function, you first need to install the [archive package](https://github.com/jimhester/archive).
