...
After that, you can replace the numbers with their respective descriptions. There is a function from the miscBR package that does the work for you. The first argument is column to be replaced, the second one is column from the second data.frame to find matches and the third argument is the replacement that comes from the second data.frame:
